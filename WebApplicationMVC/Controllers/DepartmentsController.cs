...
namespace WebApplicationMVC.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(AppDataContext context)
        {
            _context = context;
        }
        ...
        {
            var appDataContext = _context.Departments.Include(d => d.Administrator);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Budget,StartDate,InstructorID,RowVersion")] Department department)
        {
            if (id != department.ID)
            {
                return NotFound();
